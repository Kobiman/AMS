...
namespace AMS.Server.Controllers
{
    ...
    public class AccountTransactionController : ControllerBase
    {
        ...
        public AccountTransactionController(IAccountTransactionService _accTransationService, IWebHostEnvironment evn)
        {
        ...
        public async Task<IActionResult> UploadFile()
        {
            ...
            if (file != null)
            {
                ...
                return Ok(await accTransactionService.GetUploadFileName(file));
            }
